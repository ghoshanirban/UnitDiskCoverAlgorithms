...
#ifndef UDC_LL2014_1PASS_H
#define UDC_LL2014_1PASS_H
...
public:
    LL2014_1PASS(std::vector<Point> &P, std::list<Point> &diskCenters) : P(P), diskCenters(diskCenters) { }
